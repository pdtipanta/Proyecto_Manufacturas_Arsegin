 ...
 * @author David
 */
public class Dialogo_Buscar_Compra extends javax.swing.JDialog {

    /**
     * Creates new form Dialogo_Buscar_Facturas
     */
    public Dialogo_Buscar_Compra(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(parent);
        this.setResizable(false);
        this.tabla_Consulta_Compra.getTableHeader().setFont( new Font( "Arial", Font.BOLD, 13 ) );
        this.tabla_Consulta_Compra.getTableHeader().setBackground( new Color( 32, 136, 203 ));
        this.tabla_Consulta_Compra.getTableHeader().setForeground( new Color( 255, 255, 255)); 
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(985, 510));
        ...
        tabla_Consulta_Compra.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No_Orden", "Proveedor", "RUC / CI", "Valor", "", "ID Solicitante"
            }
        ) {
        ...
        if (tabla_Consulta_Compra.getColumnModel().getColumnCount() > 0) {
            tabla_Consulta_Compra.getColumnModel().getColumn(0).setPreferredWidth(100);
        }

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 190, 910, 280));
        ...
        getContentPane().add(combo_Opciones, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 30, 190, 23));
        getContentPane().add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 162, 980, 10));
        ...
        jLabel2.setMaximumSize(new java.awt.Dimension(985, 510));
        jLabel2.setMinimumSize(new java.awt.Dimension(985, 510));
        jLabel2.setPreferredSize(new java.awt.Dimension(985, 510));
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 985, 510));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Dialogo_Buscar_Compra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Dialogo_Buscar_Compra dialog = new Dialogo_Buscar_Compra(new javax.swing.JFrame(), true);
