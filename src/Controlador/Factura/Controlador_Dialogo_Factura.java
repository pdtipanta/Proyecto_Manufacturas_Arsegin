...
public class Controlador_Dialogo_Factura implements ActionListener{
    ...
    private Dialogo_Factura         dialogo_Factura;
    ...
    public void tipo_Actividad() {
        if (this.actividad.equals("Registrar")) {
            ...
            this.dialogo_Factura.valores_Clientes((String)modelo_Cliente.get(0).getCodigo_Cliente(), (String)modelo_Cliente.get(0).getCliente(), (String)modelo_Cliente.get(0).getDireccion(), (String)modelo_Cliente.get(0).getTelefono(), (String)modelo_Cliente.get(0).getRUC(), (String)modelo_Cliente.get(0).getCiudad(), this.usuario.getNombre(), this.usuario.getApellido());
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == this.dialogo_Factura.boton_Agregar_Cliente) {
            ...
            if (cliente.size() == 1) {
                this.dialogo_Factura.valores_Clientes(cliente.get(0).getCodigo_Cliente(), cliente.get(0).getCliente(), cliente.get(0).getDireccion(), cliente.get(0).getTelefono(), cliente.get(0).getRUC(), cliente.get(0).getCiudad(), this.usuario.getNombre(), this.usuario.getApellido());
                this.dialogo_Factura.boton_Agregar_Fila.setEnabled(true);
                this.dialogo_Factura.boton_Quitar_Fila.setEnabled(true);
                this.dialogo_Factura.valor_IVA.setEnabled(true);
//this.dialogo_Factura.botones(true, true, false, true, true);
            }
        }
