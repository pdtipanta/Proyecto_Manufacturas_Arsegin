...
public class Controlador_Dialogo_Orden_Compra implements ActionListener{
   ...
   private DefaultTableModel modelo_tabla_Productos_Orden_Compra;
   ...
   // private final Orden_Compra     modelo_Orden_Compra;
    ...
    public void tipo_Actividad() {
        if (this.actividad.equals("Registrar")) {
            ...
            this.dialogo_Orden_Compra.valores_Tabla_Orden(this.modelo_Orden_Compra, this.modelo_Proveedor);
        }
    }}
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == this.dialogo_Orden_Compra.boton_Buscar_Proveedor_Orden) {
            ...
            if (proveedor.size() == 1) {
                this.dialogo_Orden_Compra.valores_Proveedores(proveedor.get(0).getProveedor(), proveedor.get(0).getDireccion(), proveedor.get(0).getTelefono(), proveedor.get(0).getCorreo(), proveedor.get(0).getRUC(), this.usuario.getNombre(), this.usuario.getApellido());
        ...
        if (ae.getSource() == this.dialogo_Orden_Compra.boton_Agregar_Fila) {
            ...
            Object[] inventario = new Controlador_Dialogo_Buscar_Producto_Orden_Compra(this.vista, this.conexion_Database, this.dialogo_Orden_Compra).iniciar();
            if (inventario != null) {
