 ...
 * @author David
 */
    public class PlaceHolder_Textos extends JLabel implements FocusListener, DocumentListener {
	...
	public PlaceHolder_Textos(String text, JTextComponent component) {
		this(text, component, Show.ALWAYS);
	}
        
	public PlaceHolder_Textos(String text, JTextComponent component, Show show) {
